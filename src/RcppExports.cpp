...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type update_A_j(update_A_jSEXP);
    rcpp_result_gen = Rcpp::wrap(cppbart(x_train, y_mat, x_test, x_cut, n_tree, node_min_size, n_mcmc, n_burn, Sigma_init, mu_init, sigma_mu, alpha, beta, nu, S_0_wish, A_j_vec, update_Sigma, conditional_bool, update_A_j));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_mvnbart3_cppbart", (DL_FUNC) &_mvnbart3_cppbart, 19},
    {NULL, NULL, 0}
};
